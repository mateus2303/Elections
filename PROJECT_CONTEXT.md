...
- 2026-07-20 — O tracking semanal da Atlas `1st_round_-_with_flavio-140720261102.xlsx` passou a integrar `Confrontos` como primeiro turno estimulado, cenário `Com Flávio`, Brasil/Total. Foram adicionadas 169 linhas para 10 adversários em 28 datas; categorias não candidatas foram somadas literalmente e metadados ausentes permaneceram nulos. A validação pós-importação registrou 0 erros bloqueantes e 2.606 alertas conservadores.
...
Última atualização: 2026-07-20 — Tracking Atlas de primeiro turno incorporado e validado; Monitor TSE implementado e validado com fonte oficial atual. Modelos A e B continuam separados, com o A como baseline oficial e o B pendente de backtest/homologação.
