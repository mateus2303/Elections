...
- 2026-07-20 — Durante a atualização final, `Base_nova_limpa.xlsx` estava aberto no Excel e bloqueado pelo Windows. O ZIP completo anterior foi preservado no histórico como `Pacote_Agregador_Kinea__incompleto_base_aberta_2026-07-20.zip`; `ENTREGA_FINAL/Pacote_Agregador_Kinea.zip` contém código, resultados e uma nota solicitando copiar a base separadamente. Recriar o ZIP completo depois que o Excel for fechado.
